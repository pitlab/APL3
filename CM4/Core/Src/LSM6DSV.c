...
uint8_t ObslugaLSM6DSV(void)
{
	...
	else
	{
		...
		HAL_SPI_TransmitReceive(&hspi2, chDane, chDane, 15, TOUT_SPI);
		...
		ObliczWspTemperaturowy3(stWspKalTempZyro2, uDaneCM4.dane.fTemper[TEMP_IMU2], fPrzesuniecieZyro);		//oblicz offset dla bieżącej temperatury

...
////////////////////////////////////////////////////////////////////////////////
// Wykonaj inicjalizację czujnika MMC3416xPJ
// Parametry: nic
// Zwraca: kod błędu
// Czas wykonania:
////////////////////////////////////////////////////////////////////////////////
...
uint8_t StartujPomiarMMC3416x(void)
{
	...
	return HAL_I2C_Master_Transmit_DMA(&hi2c4, MMC34160_I2C_ADR, chBuforMMC3416x, 2);	//wyślij polecenie odczytu wszystkich pomiarów
}
...
uint8_t StartujOdczytMMC3416x(void)
{
	if (uDaneCM4.dane.nZainicjowano & INIT_MMC34160)
	{
		...
		return HAL_I2C_Master_Transmit_DMA(&hi2c4, MMC34160_I2C_ADR, chBuforMMC3416x, 1);	//wyślij polecenie odczytu wszystkich pomiarów
	}
	else
		return InicjujMMC3416x();	//wykonaj inicjalizację
}

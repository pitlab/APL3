...
#define MIN_WZM_CALK	0.0001f		//minimalna wartość wzmocnienia członu całkowania
...
float StrojeniePID_KanałemRC(stStrojPID_t *stStrój, uint8_t cNrKan, stKonfPID_t *Konf, stWymianyCM4_t *WymianaCM4);

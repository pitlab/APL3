...
uint8_t AktulizacjaWysokościi1FiltraKalmanaWysokości5X6Z(stWymianyCM4_t *dane);
uint8_t AktulizacjaWysokościi2FiltraKalmanaWysokości5X6Z(stWymianyCM4_t *dane);
uint8_t AktulizacjaPrzyspieszenia1FiltraKalmanaWysokości5X6Z(stWymianyCM4_t *dane);
uint8_t AktulizacjaPrzyspieszenia2FiltraKalmanaWysokości5X6Z(stWymianyCM4_t *dane);

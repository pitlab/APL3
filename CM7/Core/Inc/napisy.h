...
#define NREJ_ODBIORNIKRC_KAN		36
#define NREJ_WYJSCIERC_KAN			37
...
#define NREJ_KALMAN_WYS				60
#define NREJ_DELTA_CZASU			61

#define LICZBA_NAZW_POZYCJI_REJESTRATORA	62

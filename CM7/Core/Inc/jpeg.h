...
#define LICZBA_TAGOW_IFD0	10	//EXTAG_IMAGE_DESCRIPTION + EXTAG_IMAGE_INPUT_MAKE + EXTAG_EQUIPMENT_MODEL + EXTAG_SOFTWARE + EXTAG_ARTIST + EXTAG_COPYRIGT + EXTAG_ORIENTATION + EXTAG_DATE_TIME + EXTAG_EXIF_IFD + EXTAG_GPS_IFD
...
#define ROZMIAR_EXIF		520		//rozmiar wyrównany tak aby kolena sekcja jpeg zaczynała się od adresu będącego wielokrotnością 4
...
#define EXTAG_COPYRIGT			0x9298	//ASCII

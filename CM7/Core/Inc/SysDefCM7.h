...
#define WER_GLOWNA	3
#define WER_PODRZ	0
#define WER_REPO	596		//numer commitu w repozytorium
...
#define TP_POMIAR_PGAP		37	//czas obiegu pętli głównej AP
...
#define TPKS_ZAP_BMP24_320	54
#define TPKS_ZAP_BMP24_240	55
#define TPKS_ZAPISZ_BIN		56
#define TPKS_ZAPISZ_BMP8	57	//zapisuje zawartość bufora ekranu do pliku bmp 8-bitowego
#define TPKS_ZAP_BMP24_480	58	//zapisuje zawartość bufora ekranu do pliku bmp 24-bitowego
...
//podmenu TP_POMIARY
#define TP_POMIARY_AHRS		90	//wyświetlaj wyniki pomiarów IMU pobrane z CM4
#define TP_POMIARY_CZUJN	91	//wyświetlaj wyniki pozostałych czujników
...
//przesunięcie flag i maska w zmiennej chStatusPolaczenia

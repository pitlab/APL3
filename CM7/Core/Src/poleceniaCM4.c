...
uint8_t ObslugaPolecenCM4(void)
{
	...
	if (uDaneCM4.dane.cWykonajPolecenie != uDaneCM7.dane.cPotwierdzenieWykonania)
	{
		uDaneCM7.dane.cPotwierdzenieWykonania = uDaneCM4.dane.cWykonajPolecenie;	//potwierdź wykonanie polecenia
		switch (uDaneCM4.dane.cWykonajPolecenie)
		{
		case POL4_NIC:			break;	//nic nie rób
		case POL4_WLACZ_OD1:	cPort_exp_wysylany[0] |= EXP06_MOD_OD1;	break;	//włącz wyjście otwarty dren 1
		case POL4_WLACZ_OD2:	cPort_exp_wysylany[0] |= EXP07_MOD_OD2;	break;	//włącz wyjście otwarty dren 2
		case POL4_WYLACZ_OD1:	cPort_exp_wysylany[0] &= ~EXP06_MOD_OD1;	break;	//wyłącz wyjście otwarty dren 1
		case POL4_WYLACZ_OD2:	cPort_exp_wysylany[0] &= ~EXP07_MOD_OD2;	break;	//wyłącz wyjście otwarty dren 2
		...
		case POL4_CZYTAJ_KALIBR_TEMP:
			...
			uDaneCM7.dane.cWykonajPolecenie = POL7_CZYTAJ_KALIBR_TEMP;
			break;
		}
	}
	return cBłąd;
